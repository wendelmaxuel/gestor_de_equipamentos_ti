  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="index.html" class="logo"><b>SYS TOQ GESTOR</b></a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">SYS TOQ GESTOR</span>
                </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="pages/produtos/add_product.php"><i class="fa fa-circle-o"></i>Cadastrar produto</a></li>
                <li><a href="pages/produtos/add_category.php"><i class="fa fa-circle-o"></i>Adicionar categoria</a></li>
                <li><a href="pages/estoque/entries.php"><i class="fa fa-circle-o"></i>Entrada Projeto</a></li>
                <li><a href="pages/estoque/exits.php"><i class="fa fa-circle-o"></i>Saida Projeto</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small> <a href="https://rdslprod.service-now.com/now/nav/ui/classic/params/target/task_
            list.do%3Fsysparm_query%3Dassignment_group%253Djavascript%3AgetMyGroups()%255Eactive%253D
            true%255Eassigned_to%253D%255Estate!%253D-5%255EGROUPBYassignment_group%26sysparm_first_ro
            w%3D1%26sysparm_view%3D" target=”_blank” class="small-box-footer"><i class="fa fa-arrow-circle-right"></i>  <b> SERVICE NOW </b> </a></small>
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-gray">
                <div class="inner">
                  <h3>Maquinas de<br>Projeto</h3>
                  <p>Projeto em Obras</p>
                </div>
                <div class="icon">
                </div>
                <a href="pages/produtos/product.php" class="small-box-footer"> Acessar  <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-gray">
                <div class="inner">
                  <h3>Entrada de<br>Maquinas</h3>
                  <p>Projeto em Obras</p>
                </div>
                <div class="icon">
                
                </div>
                <a href="pages/relatorio/entries.php" class="small-box-footer"> Acessar  <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-yellow">
                <div class="inner">
                  <h3>Saída de<br>Maquinas</h3>
                  <p>Finalizado</p>
                </div>
                <div class="icon">
                
                </div>
                <a href="pages/relatorio/exits.php" class="small-box-footer"> Acessar  <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-blue">
                <div class="inner">
                  <h3>Pesquisa por<br>chamado</h3>
                  <p>Nome ou Nº do chamado</p>
                </div>
                <div class="icon">
                 
                </div>
                <a href="pages/relatorio/saidas_buscar.php" class="small-box-footer"> Acessar <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
          </div><!-- /.row -->
          <!-- Main row -->
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-blue">
                ...
                <a href="https://rdslprod.service-now.com/now/nav/ui/classic/params/target/task_list.do%3Fsysparm_
                query%3Dassignment_group%253Djavascript%3AgetMyGroups()%255Eactive%253Dtrue%255Eassigned_to%253D%2
                55Estate!%253D-5%255EGROUPBYassignment_group%26sysparm_first_row%3D1%26sysparm_view%3D" target=”_blank” 
                class="small-box-footer"><i class="fa fa-arrow-circle-right"></i>  <b> SERVICE NOW </b> </a></small>
              </div>
            </div><!-- ./col -->
          </div><!-- /.row -->
          <!-- Main row -->
